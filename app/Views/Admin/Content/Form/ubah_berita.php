                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd" style="margin-bottom: 50px;">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">UPDATE</span> BERITA</h1>
                        </div>
                    </div>
                    <form action="/Berita/save_update" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <select name="kategori" id="kategori" class="form-control">
                                        ...
                                        <?php foreach ($kat as $row) { ?>
                                            <option <?= ($row['id_kategori_berita'] == $berita['id_kategori_berita']) ? 'selected' : ''; ?> value="<?= $row['id_kategori_berita']; ?>"><?= $row['nama_kategori_berita']; ?></option>
                                        <?php } ?>
                                    </select>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <input type="date" name="tgl_dilaksanakan" id="tgl_dilaksanakan" class="form-control" required placeholder="Masukkan judul berita" value="<?= $berita['tgl_dilaksanakan']; ?>" />
